package lesson19.classwork2204.example02;

public class Car {// доп задача: доказать, что это присвоение действительно будет происходить во время вызова конструктора
